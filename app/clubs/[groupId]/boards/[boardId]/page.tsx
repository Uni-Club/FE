    ...
    <main className="pt-28 pb-20 px-4 sm:px-6 lg:px-8 min-h-screen bg-slate-50">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-lg text-slate-600">{board?.description}</p>
        </div>
                  ...
                  <div className="flex items-start gap-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        {post.isPinned && (
                          <span className="px-2 py-1 bg-indigo-100 text-indigo-600 text-xs rounded-md font-semibold flex items-center gap-1">
